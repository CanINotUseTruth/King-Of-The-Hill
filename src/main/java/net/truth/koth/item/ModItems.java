...
public class ModItems {
    public static final Item KINGS_CROWN = registerItem("kings_crown",
            new KingsCrownItem(new FabricItemSettings().maxCount(1).fireproof().group(ModItemGroup.KOTH_GROUP)));
    public static final Item CROWN_LOCATOR = registerItem("crown_locator",
            new CrownLocatorItem(new FabricItemSettings().maxCount(1).group(ModItemGroup.KOTH_GROUP)));
